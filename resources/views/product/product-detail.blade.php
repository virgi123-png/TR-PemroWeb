					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="{{ asset('storage/' . $product->foto_produk) }}">
									<div class="wrap-pic-w pos-relative">
										<img src="{{ asset('storage/' . $product->foto_produk) }}" alt="{{ $product->nama_produk }}">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('storage/' . $product->foto_produk) }}">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<p class="stext-102 cl3 p-t-23">
							{{ $product->deskripsi_singkat_produk ?? 'Deskripsi tidak tersedia' }}
						</p>
							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<span class="stext-102 cl6">
										{{ $product->stock_produk > 0 ? $product->stock_produk . ' tersedia' : 'Stok habis' }}
									</span>
								</div>
							</div>
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="{{ asset('storage/' . $related->foto_produk) }}" alt="{{ $related->nama_produk }}">

								<a href="{{ route('product.detail', $related->id) }}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
									Quick View
								</a>
							</div>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="{{ route('product.detail', $related->id) }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										{{ $related->nama_produk }}
									</a>

									<span class="stext-105 cl3">
										${{ number_format($related->harga_produk, 2) }}
									</span>
								</div>
